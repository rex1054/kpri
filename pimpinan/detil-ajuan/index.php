...
<link href="<?php echo $siteurl;?>assets/css/pimpinan/ajuan.css" rel="stylesheet">
...
<div class=kolom_profil>
    ...
    <div class=tombol_container>
                <div class=tombol_acc>
                    <button class="tombol_kembali_background" onclick="acc(<?php echo $_GET['id'].', '.$_SESSION['nip'].', 3'; ?>)">
                        <span class="teks_kembali">ACC</span>
                    </button>
                </div>
                <div class=tombol_tolak>
                    <button class="tombol_kembali_background" onclick="acc(<?php echo $_GET['id'].', '.$_SESSION['nip'].', 4'; ?>)">
                        <span class="teks_kembali">TOLAK</span>
                    </button>
                </div>
