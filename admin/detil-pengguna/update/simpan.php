...
if($con->query($sql)){
    ?>
    <script>alert("Berhasil memperbarui data."); window.open("<?php echo $siteurl."admin/detil-pengguna/?nip=".$nip; ?>", "_SELF");</script>
    <?php
} else {
    ?>
    <script>alert("Gagal memperbarui data."); window.open("<?php echo $siteurl."admin/detil-pengguna/?nip=".$nip; ?>", "_SELF");</script>
    <?php
}
