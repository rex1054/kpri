...
$sql = "SELECT akun.nama, akun.nip, kelamin.kelamin, akun.tempat_lahir, akun.tanggal_lahir, akun.alamat, akun.pos, akun.hp, instansi.instansi, instansi.alamat as alamat_instansi, akun.ktp_suami, akun.ktp_istri, akun.foto_3x4, status_akun.status, jabatan.jabatan, akun.gabung FROM akun join kelamin on akun.kelamin = kelamin.id join instansi on akun.instansi = instansi.id join status_akun on akun.status = status_akun.id join jabatan on akun.jabatan = jabatan.id WHERE akun.nip = ".$_GET['nip'];
...
<body>
    <div class=melihat_data_pengguna>
        <div class=header_container>
            <div class="logo"></div><span class="teks_koperasi">KOPERASI PEGAWAI REPUBLIK INDONESIA</span><span
                class="teks_nama_koperasi">WIYATA USAHA</span><span class="teks_alamat_koperasi">Jl. Krakatau No.216,
        ...
        <div class=kolom_profil>
            ...
            <div class="foto_profil"
                style="background-image: url('<?php echo $siteurl.'assets/i/user_3x4/'.$data['foto_3x4']; ?>');"></div>
            <div class=data_kiri_container>
                <div class=nama><span class="teks_nama">Nama</span><span class="data_nama">:
                        <?php echo $data['nama']; ?></span></div>
                <div class=nip><span class="teks_nip">NIP</span><span class="data_nip">:
                        <?php echo $data['nip']; ?></span></div>
                <div class=kelamin><span class="teks_kelamin">Jenis kelamin</span><span class="data_kelamin">:
                        <?php echo $data['kelamin']; ?></span></div>
                <div class=tempat_lahir><span class="teks_tempat_lahir">Tempat lahir</span><span
                        class="data_tempat_lahir">: <?php echo $data['tempat_lahir']; ?></span></div>
                <div class=tanggal_lahir><span class="teks_tanggal_lahir">Tanggal lahir</span><span
                        class="data_tanggal_lahir">: <?php echo $data['tanggal_lahir']; ?></span></div>
                <div class=alamat_rumah><span class="teks_alamat_rumah">Alamat rumah</span><span
                        class="data_alamat_rumah" style="overflow-y: scroll;">: <?php echo $data['alamat']; ?></span>
                </div>
                <div class=pos><span class="teks_pos">Kode pos</span><span class="data_pos">:
                        <?php echo $data['pos']; ?></span></div>
            </div>
            <div class=data_kanan_container>
                <div class=hp><span class="teks_hp">Nomor HP</span><span class="data_hp">:
                        <?php echo $data['hp']; ?></span></div>
                <div class=instansi><span class="teks_instansi">Instansi</span><span class="data_instansi">:
                        <?php echo $data['instansi']; ?></span></div>
                <div class=alamat_instansi><span class="teks_alamat_instansi">Alamat instansi</span><span
                        class="data_alamat_instansi" style="overflow-y: scroll;">:
                        <?php echo $data['alamat_instansi']; ?></span></div>
                <div class=ktp_suami><span class="teks_ktp_suami">Foto KTP suami</span><span class="data_ktp_suami">:
                        <?php echo $data['ktp_suami']; ?><img id="ktp-suami-show" class="kpri-profile-show-icon"
                            src="<?php echo $siteurl; ?>assets/show.png"></span></div>
                <div class=ktp_istri><span class="teks_ktp_istri">Foto KTP istri</span><span class="data_ktp_istri">:
                        <?php echo $data['ktp_istri']; ?><img id="ktp-istri-show" class="kpri-profile-show-icon"
                            src="<?php echo $siteurl; ?>assets/show.png"></span></div>
                <div class=foto_3x4><span class="teks_3x4">Foto 3x4</span><span class="data_3x4">:
                        <?php echo $data['foto_3x4']; ?><img id="foto-3x4-show" class="kpri-profile-show-icon"
                            src="<?php echo $siteurl; ?>assets/show.png"></span></div>
                <div class=registrasi><span class="teks_registrasi">Tanggal registrasi</span><span
                        class="data_registrasi">: <?php echo $data['gabung']; ?></span></div>
            </div>
            <div class=tombol>
    ...
    <div id="modal-ktp-suami" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo $siteurl; ?>assets/i/user_ktp_suami/<?php echo $data['ktp_suami'];?>"
                    alt="<?php echo $siteurl; ?>assets/i/user_ktp_suami/<?php echo $data['ktp_suami'];?>">
            </div>
            <div class="modal-footer">
                ...
                <div class="modal-footer-right">
                    <a href="<?php echo $siteurl; ?>assets/i/user_ktp_suami/<?php echo $data['ktp_suami'];?>"
                        target="_blank"><button type="button" class="kpri-tombol-ubah">Ukuran Penuh</button></a>
    ...
    <div id="modal-ktp-istri" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo $siteurl; ?>assets/i/user_ktp_istri/<?php echo $data['ktp_istri'];?>"
                    alt="<?php echo $siteurl; ?>assets/i/user_ktp_istri/<?php echo $data['ktp_istri'];?>">
            </div>
            <div class="modal-footer">
                <div class="modal-footer-left">
                    <h3>KPRI Wiyata Usaha</h3>
                ...
                <div class="modal-footer-right">
                    <a href="<?php echo $siteurl; ?>assets/i/user_ktp_istri/<?php echo $data['ktp_istri'];?>"
                        target="_blank"><button type="button" class="kpri-tombol-ubah">Ukuran Penuh</button></a>
    ...
    <div id="modal-3x4" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="<?php echo $siteurl; ?>assets/i/user_3x4/<?php echo $data['foto_3x4'];?>"
                    alt="<?php echo $siteurl; ?>assets/i/user_3x4/<?php echo $data['foto_3x4'];?>">
            </div>
            <div class="modal-footer">
                <div class="modal-footer-left">
                    <h3>KPRI Wiyata Usaha</h3>
                ...
                <div class="modal-footer-right">
                    <a href="<?php echo $siteurl; ?>assets/i/user_3x4/<?php echo $data['foto_3x4'];?>"
                        target="_blank"><button type="button" class="kpri-tombol-ubah">Ukuran Penuh</button></a>
                    ...
                    <div class="input-foto">
                        <div class="kata_sandi_1_2411">
                            <div class="kolom_kata_sandi_1_2421 tooltip">
                                <input class="kpri-input kpri-specials" required name="sandi-baru" id="kpri-kata-sandia"
                                    type="password" placeholder="KATA SANDI BARU">
                                <span class="tooltiptext">Kata sandi baru</span>
                                <span class="kpri-sandi">
                                    <a id="tampilkan-sandia" href="#" onclick="tampilsandia()">
                                        <img class="kpri-logo-specials" id="kpri-logo-passworda"
                                            style="position: absolute; left: 126px; top: 6px;"
                                            src="<?php echo $siteurl; ?>assets/show.png">
                                    </a>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="kata_sandi_1_2412">
                            <div class="kolom_kata_sandi_1_2422 tooltip">
                                <input class="kpri-input kpri-specials" required name="konfirmasi-sandi"
                                    id="kpri-kata-sandib" type="password" placeholder="KONFIRMASI KATA SANDI BARU">
                                <span class="tooltiptext">Konfirmasi kata sandi baru</span>
                                <span class="kpri-sandi">
                                    <a id="tampilkan-sandib" href="#" onclick="tampilsandib()">
                                        <img class="kpri-logo-specials" id="kpri-logo-passwordb"
                                            style="position: absolute; left: 126px; top: 6px;"
                                            src="<?php echo $siteurl; ?>assets/show.png">
                                    </a>
                                </span>
