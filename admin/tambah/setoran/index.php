...
<input class="input-bulan ajuan-input" id="bulan" name="bulan" type="month" required></div>
...
<input class="input_ke_810_62 kpri-input" id="ke" type="number" disabled>
<input name="ke" id="kee" type="number" hidden>
<input class="input_dari_810_76 kpri-input" id="dari" type="number" disabled>
<input name="dari" id="darii" type="number" hidden>
<span  class="teks_slash_810_77">/</span>
</div>
<div class=pokok_810_63><span  class="teks_jasa_810_64">Pokok</span>
<input class="input_pokok_810_65 kpri-input" name="pokoke" id="pokok" type="number" onchange="jumlah()" disabled>
<input name="pokok" id="pokokk" type="number" onchange="jumlah()" hidden>
</div>
<div class=jasa_810_66><span  class="teks_jasa_810_67">Jasa</span>
<input class="input_jasa_810_68 kpri-input" name="jasae" id="jasa" type="number" onchange="jumlah()" disabled>
<input name="jasa" id="jasaa" type="number" onchange="jumlah()" hidden>
</div>
